...
"none";c.container.querySelector(".InfoCard-tab-content[data-id='"+this.dataset.id+"']").style.display="block"},!1)};this.destroy=function(){c.container.removeChild(c.card);c.container.innerHTML=""};this.createCard()};
